...
const dataRoot = process.env.CATALOGUE_CANDIDATE_ROOT || root;
const relicOutputFile = join(dataRoot, "src/data/relic-sets.json");
const characterOutputFile = join(dataRoot, "src/data/characters.json");
